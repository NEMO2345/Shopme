...
public class OrderController {
	...
	private void updateProductDetails(Order order, HttpServletRequest request) {
		...
		for(int i = 0 ; i < detailIds.length ; i++) {
			...
			System.out.println("Detail ID:" +productIds[i] );
			System.out.println("Detail ID:" +productDetailCosts[i] );
			System.out.println("Detail ID:" +quantities[i] );
			System.out.println("Detail ID:" +productSubtotals[i] );
			System.out.println("Detail ID:" +productShipCosts[i] );
