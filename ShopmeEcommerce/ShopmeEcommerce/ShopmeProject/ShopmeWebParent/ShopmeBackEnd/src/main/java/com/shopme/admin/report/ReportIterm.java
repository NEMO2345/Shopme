...
public class ReportIterm {
	...
	public ReportIterm(String identifier) {
		this.identifier = identifier;
	}

	

	public ReportIterm(String identifier, float grossSales, float netSales) {
		this.identifier = identifier;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReportIterm other = (ReportIterm) obj;
