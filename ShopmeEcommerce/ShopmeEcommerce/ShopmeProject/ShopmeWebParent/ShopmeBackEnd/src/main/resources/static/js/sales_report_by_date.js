...
function loadSalesReportByDate(period) {
  ...
  $.get(requestURL, function(responseJSON) {
    prepareChartData(responseJSON); // Truyền responseJSON vào prepareChartData
    customizeChart(period);
    drawChart(period);
  });
}

function prepareChartData(responseJSON) { // Truyền responseJSON từ tham số
  ...
  totalGrossSales = 0.0; // Đặt lại giá trị về 0
  totalNetSales = 0.0; // Đặt lại giá trị về 0
  totalOrders = 0; // Đặt lại giá trị về 0
