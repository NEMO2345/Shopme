...
$(document).ready(function(){
	buttonLoad4States = $("#buttonLoadCoutriesForStates");
...
function changeFormStateToSelectedState(){
	...
	labelStateName.text("Seleted State/Province:");
	
	seletedStateName = $("#dropDownStates option:selected").text();
	fieldStateName.val(seletedStateName);
